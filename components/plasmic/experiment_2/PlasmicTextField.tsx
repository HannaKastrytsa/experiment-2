...
import Label from "../../Label"; // plasmic-import: zEbP8J2lEf8_/component
import TextInput from "../../TextInput"; // plasmic-import: jVIt2ZzM_8v2/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: BKsXUSUT_-kG/component
import Description from "../../Description"; // plasmic-import: kXIKZzql0ZBq/component

import "@plasmicapp/react-web/lib/plasmic.css";

import projectcss from "./plasmic.module.css"; // plasmic-import: noTA7aKy3vvJRvLc2vAqcb/projectcss
import sty from "./PlasmicTextField.module.css"; // plasmic-import: je-pzjKv-O25/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__iPt8Y, {
          [sty.freeBoxiconEnd__iPt8Yds5TX]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__iPt8Y1EzrM]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__iPt8YAiD7G]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__vXmkt, {
            [sty.freeBoxiconStart__vXmkt1EzrM]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__vXmktAiD7G]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__wnghe)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__w7XH, {
            [sty.freeBoxiconEnd__w7XHds5TX]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__w7XH1EzrM]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg___9J152)}
                role={"img"}
              />
            ),
